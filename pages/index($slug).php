...
DB::insert('insert into `unique_views` (`type`,`post_id`,`ip`,`day`,`requests`) values (2,?,?,DATE(NOW()),1) ON DUPLICATE KEY UPDATE `requests`=`requests`+1;',$data['posts']['id'],$_SERVER['REMOTE_ADDR']);
