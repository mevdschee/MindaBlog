...
DB::insert('insert into `unique_views` (`type`,`post_id`,`ip`,`day`,`requests`) values (3,NULL,?,DATE(NOW()),1) ON DUPLICATE KEY UPDATE `requests`=`requests`+1;',$_SERVER['REMOTE_ADDR']);
